...
export const products: Product[] = [
  {
    ...
    details: {
      ...
      colors: ['بيج', 'رمادي فحمي', 'أزرق كحلي'],
    },
    price: {
      type: 'fixed',
      value: 1899.99,
  ...
  },
  {
    ...
    details: {
      ...
      colors: ['رخام أبيض مع قاعدة سوداء', 'رخام أبيض مع قاعدة ذهبية'],
    },
    price: {
      type: 'fixed',
      value: 2500.0,
  ...
  },
  {
    ...
    details: {
      ...
      colors: ['أبيض سحابي', 'رمادي حصوي', 'أخضر غابي', 'أزرق محيطي عميق'],
    },
    price: {
      type: 'on-demand',
    },
  },
  {
    ...
    details: {
      ...
      colors: ['بلوط فاتح', 'جوزي', 'أبيض مطفي'],
    },
    price: {
      type: 'on-demand',
    },
  },
  {
    ...
    details: {
        ...
        colors: ['تشطيب طبيعي', 'صبغة جوز داكن'],
    },
    price: {
        type: 'fixed',
        value: 1250.00
  ...
  },
  {
    ...
    details: {
        ...
        colors: ['أبيض لامع', 'أسود مطفي', 'رمادي معدني'],
    },
    price: {
        type: 'on-demand'
    }
